...
function create() {
    ...
    var frameNames = Phaser.Animation.generateFrameNames('octopus', 0, 24, '', 4);	//详见源码src/animation/Animation.js或http://www.phaserengine.com/docs/detail/animation

    //  Here is the important part. Group.callAll will call a method that exists on every child in the Group.
    //  In this case we're saying: child.animations.add('swim', frameNames, 30, true, false)	//详见源码src/animation/AnimationManager.js
    ...
    group.callAll('animations.add', 'animations', 'swim', frameNames, 30, true, false);	//详见源码src/animation/Groups.js
